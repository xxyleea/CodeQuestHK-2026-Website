...
export function Hero() {
  ...
  return (
    <div id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-blue-900 to-cyan-900">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-4">
            Hong Kong's first true 48-hour hackathon where students build from scratch—no pre-prepared projects allowed.
          </p>
          <p className="text-lg text-cyan-300 max-w-3xl mx-auto mb-8">
            This year's theme: <span className="font-semibold">"Technology Consulting for the Future"</span>
          </p>
