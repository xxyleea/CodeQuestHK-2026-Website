...
import { Calendar, MapPin, Users, Target, Trophy, BookOpen } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          >
            ...
            <h3 className="text-gray-900 mb-3 font-bold" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 600 }}>Dates</h3>
            <div className="space-y-2 text-gray-700">
              ...
              <div className="mt-3 text-sm text-cyan-600">During CNY holidays</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-gray-900 mb-3 font-bold" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 600 }}>Participants</h3>
            <div className="space-y-2 text-gray-700">
              <div>60-80 Secondary Students</div>
              <div className="text-sm text-gray-600">S1-S5 from 30+ schools</div>
              ...
              <div className="text-sm text-gray-600">Randomized cross-school</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-gray-900 mb-3 font-bold" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 600 }}>Venue</h3>
            <div className="space-y-2 text-gray-700">
        ...
        >
          <div className="grid md:grid-cols-2 gap-8">
            <div className="text-white">
              ...
              <h3 className="text-white mb-4">2026 Theme: Technology Consulting for the Future</h3>
              <p className="text-white/90 mb-4">
                This year, students act as junior tech consultants, receiving real business pain points from 
                sponsoring companies. Examples could include retail customer experience optimization, 
                smart logistics solutions, or other industry challenges.
              </p>
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 bg-white rounded-full" />
                  <span className="text-sm">Interview company representatives</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 bg-white rounded-full" />
            ...
            <div className="text-white">
              ...
              <div className="space-y-4">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  ...
                  <div className="text-sm text-white/80">For students in S1-S3</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  <div className="mb-2">Senior Category</div>
                  <div className="text-sm text-white/80">For students in S3-S5</div>
                </div>
              </div>
              <p className="text-sm text-white/80 mt-4">
                All development must happen within the 48-hour window—exactly like a real consulting sprint
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: 'Design Thinking Workshop', desc: 'Learn user-centered problem solving' },
              { title: 'Pitch Training', desc: 'Master professional presentation skills' },
              { title: 'Tech Stack Sessions', desc: 'Get familiar with development tools' },
              { title: 'Consulting Frameworks', desc: 'Understand business analysis methods' },
              { title: 'Mentorship', desc: 'Industry mentors guide your team' },
              { title: 'Judging Panel', desc: 'Corporate reps & tech professionals' },
            ].map((item, index) => (
              <div
                key={item.title}
