    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            <h3
              className="text-gray-900 mb-4 text-2xl font-bold"
              style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 700 }}
            >
            ...
            <div className="space-y-4 text-gray-600">
              ...
              <p>
                <strong>Each year brings a new challenge theme.</strong> In
                2025, we ran a game development jam where students created
                original games celebrating Hong Kong culture and sustainability.
                In 2026, participants become junior tech consultants, solving
                real business problems from industry partners.
              </p>
              <p>
                Students are randomly assigned to cross-school teams of 3–5,
                fostering new connections and collaboration across Hong Kong's
                education landscape.
              </p>
            </div>
          </motion.div>
        ...
        >
          <div className="text-center">
            ...
            <h4
              className="text-gray-900 mb-2 font-bold"
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              2025: Game Development
              <br />
              2026: Tech Consulting
            </p>
          </div>
